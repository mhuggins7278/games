...
<div class="text-center">
	...
	<div class="flex flex-row justify-center">
		<div class="shadow-2xl grid gap-1 grid-rows-3 grid-cols-3 bg-gray place-items-center">
		...
		<button
			class="bg-blue hover:bg-blue-dark text-white font-bold py-2 px-4 rounded my-12"
